 ...
 *
 *
 * mod_unc_ivr.c -- Framework Demo Module
 *
 */
#include <switch.h>

/* Prototypes */
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_unc_ivr_shutdown);
SWITCH_MODULE_RUNTIME_FUNCTION(mod_unc_ivr_runtime);
SWITCH_MODULE_LOAD_FUNCTION(mod_unc_ivr_load);

/* SWITCH_MODULE_DEFINITION(name, load, shutdown, runtime) 
 * Defines a switch_loadable_module_function_table_t and a static const char[] modname
 */
SWITCH_MODULE_DEFINITION(mod_unc_ivr, mod_unc_ivr_load, mod_unc_ivr_shutdown, NULL);
...
static switch_status_t do_config(switch_bool_t reload)
{
	...
	if (switch_xml_config_parse_module_settings("unc_ivr.conf", reload, instructions) != SWITCH_STATUS_SUCCESS) {
		switch_log_printf(SWITCH_CHANNEL_LOG, SWITCH_LOG_CRIT, "Could not open unc_ivr.conf\n");
...
SWITCH_STANDARD_API(unc_ivr_function)
{
...
/* Macro expands to: switch_status_t mod_unc_ivr_load(switch_loadable_module_interface_t **module_interface, switch_memory_pool_t *pool) */
SWITCH_MODULE_LOAD_FUNCTION(mod_unc_ivr_load)
{
	...
	*module_interface = switch_loadable_module_create_module_interface(pool, modname);
	...
	SWITCH_ADD_API(api_interface, "unc_ivr", "unc_ivr API", unc_ivr_function, "syntax");
...
/*
  ...
  Macro expands to: switch_status_t mod_unc_ivr_shutdown() */
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_unc_ivr_shutdown)
{
...
/*
  ...
  Macro expands to: switch_status_t mod_unc_ivr_runtime()
SWITCH_MODULE_RUNTIME_FUNCTION(mod_unc_ivr_runtime)
{
	while(looping)
	{
