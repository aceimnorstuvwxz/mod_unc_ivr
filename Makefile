...
# src/mod/applications/mod_unc_ivr/Makefile.  Generated from Makefile.in by configure.
...
subdir = src/mod/applications/mod_unc_ivr
...
mod_unc_ivr_la_DEPENDENCIES = $(switch_builddir)/libfreeswitch.la
am_mod_unc_ivr_la_OBJECTS = mod_unc_ivr_la-mod_unc_ivr.lo
mod_unc_ivr_la_OBJECTS = $(am_mod_unc_ivr_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
mod_unc_ivr_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(mod_unc_ivr_la_CFLAGS) \
	$(CFLAGS) $(mod_unc_ivr_la_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(mod_unc_ivr_la_SOURCES)
DIST_SOURCES = $(mod_unc_ivr_la_SOURCES)
...
EGREP = /bin/grep -E
ERLANG = /usr/bin/erl
ERLANG_CFLAGS = -I/usr/lib/erlang/lib/erl_interface-3.7.18/include 
ERLANG_LDFLAGS = -L/usr/lib/erlang/lib/erl_interface-3.7.18/lib  -lei
ESL_LDFLAGS = 
EXEEXT = 
FGREP = /bin/grep -F
...
G7221_CFLAGS = 
G7221_LIBS = -lg722_1 -lm 
GETG729 = cd /usr/src/freeswitch.git/libs && /bin/bash /usr/src/freeswitch.git/build/getg729.sh
GETLIB = cd /usr/src/freeswitch.git/libs && /bin/bash /usr/src/freeswitch.git/build/getlib.sh
GETSOUNDS = /bin/bash /usr/src/freeswitch.git/build/getsounds.sh
GREP = /bin/grep
...
MONGOC_LIBS = -lrt -lmongoc-1.0 -lbson-1.0 
MP3LAME_CFLAGS = 
...
PACKAGE_STRING = freeswitch 1.6.7
...
PCRE_LIBS = -lpcre 
PERL = perl
PERL_CFLAGS = -w -DMULTIPLICITY  -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fwrapv -fno-strict-aliasing -pipe -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -I/usr/lib/x86_64-linux-gnu/perl/5.20/CORE  -DEMBED_PERL
PERL_INC =  -I/usr/lib/x86_64-linux-gnu/perl/5.20/CORE 
PERL_LDFLAGS = -Wl,-E  -fstack-protector -L/usr/local/lib  -L/usr/lib/x86_64-linux-gnu/perl/5.20/CORE -lperl -ldl -lm -lpthread -lc -lcrypt
PERL_LIBDIR = -L/usr/lib/x86_64-linux-gnu/perl/5.20/CORE
PERL_LIBS = -lgdbm -lgdbm_compat -ldb -ldl -lm -lpthread -lc -lcrypt
PERL_SITEDIR = /usr/lib/x86_64-linux-gnu/perl/5.20
PG_CONFIG = 
PHP = php
PHP_CFLAGS = 
...
PYTHON_CFLAGS = -I/usr/include/python2.7 -I/usr/include/python2.7 -fno-strict-aliasing -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security
...
STRIP = strip
SWITCH_AM_CFLAGS = -I/usr/include/uuid  -I/usr/src/freeswitch.git/src/include -I/usr/src/freeswitch.git/src/include -I/usr/src/freeswitch.git/libs/libteletone/src -fPIC -Werror -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DHAVE_VISIBILITY=1 -Wno-unused-result -g -ggdb -DHAVE_OPENSSL
SWITCH_AM_CPPFLAGS = -I/usr/src/freeswitch.git/src/include -I/usr/src/freeswitch.git/src/include -I/usr/src/freeswitch.git/libs/libteletone/src
SWITCH_AM_CXXFLAGS = -I/usr/src/freeswitch.git/src/include -I/usr/src/freeswitch.git/src/include -I/usr/src/freeswitch.git/libs/libteletone/src -fPIC -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DHAVE_VISIBILITY=1
...
YAML_LIBS = -lyaml 
ZCAT = /bin/gunzip
abs_builddir = /usr/src/freeswitch.git/src/mod/applications/mod_unc_ivr
abs_srcdir = /usr/src/freeswitch.git/src/mod/applications/mod_unc_ivr
abs_top_builddir = /usr/src/freeswitch.git
abs_top_srcdir = /usr/src/freeswitch.git
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
MODNAME = mod_unc_ivr
mod_LTLIBRARIES = mod_unc_ivr.la
mod_unc_ivr_la_SOURCES = mod_unc_ivr.c
mod_unc_ivr_la_CFLAGS = $(AM_CFLAGS)
mod_unc_ivr_la_LIBADD = $(switch_builddir)/libfreeswitch.la
mod_unc_ivr_la_LDFLAGS = -avoid-version -module -no-undefined -shared
all: all-am
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/build/modmake.rulesam $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign src/mod/applications/mod_unc_ivr/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign src/mod/applications/mod_unc_ivr/Makefile
.PRECIOUS: Makefile
...
mod_unc_ivr.la: $(mod_unc_ivr_la_OBJECTS) $(mod_unc_ivr_la_DEPENDENCIES) $(EXTRA_mod_unc_ivr_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(mod_unc_ivr_la_LINK) -rpath $(moddir) $(mod_unc_ivr_la_OBJECTS) $(mod_unc_ivr_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/mod_unc_ivr_la-mod_unc_ivr.Plo
...
mod_unc_ivr_la-mod_unc_ivr.lo: mod_unc_ivr.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_unc_ivr_la_CFLAGS) $(CFLAGS) -MT mod_unc_ivr_la-mod_unc_ivr.lo -MD -MP -MF $(DEPDIR)/mod_unc_ivr_la-mod_unc_ivr.Tpo -c -o mod_unc_ivr_la-mod_unc_ivr.lo `test -f 'mod_unc_ivr.c' || echo '$(srcdir)/'`mod_unc_ivr.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/mod_unc_ivr_la-mod_unc_ivr.Tpo $(DEPDIR)/mod_unc_ivr_la-mod_unc_ivr.Plo
#	$(AM_V_CC)source='mod_unc_ivr.c' object='mod_unc_ivr_la-mod_unc_ivr.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_unc_ivr_la_CFLAGS) $(CFLAGS) -c -o mod_unc_ivr_la-mod_unc_ivr.lo `test -f 'mod_unc_ivr.c' || echo '$(srcdir)/'`mod_unc_ivr.c
